...
| Engine Evidence[] | EvolveLoop `memory/*/evidence/` | In-run proof objects vs PDA gate JSON files | Both called “Evidence Bus” | Engine does not write gate JSON | **Complementary / vocabulary collision** | EA-0006, EA-0007 |
