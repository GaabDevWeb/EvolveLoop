# git — SKILL CERTIFICATION

## Identity
- **skill_id:** git
- **version:** UNKNOWN
- **path:** /home/gaab/Downloads/CursorSKILLS/orchestrator/providers/git
...
Validated dimensions: discovery, happy, negative, adversarial, authority, scope, failure, evidence
