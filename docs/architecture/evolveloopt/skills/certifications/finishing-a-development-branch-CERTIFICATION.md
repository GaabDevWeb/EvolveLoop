# finishing-a-development-branch — SKILL CERTIFICATION

## Identity
- **skill_id:** finishing-a-development-branch
- **version:** UNKNOWN
- **path:** /home/gaab/Downloads/CursorSKILLS/global-skills/finishing-a-development-branch
- **source:** global-skills
- **purpose:** Finishing a Development Branch

## Classification
HOST-DEPENDENT, META/ORCHESTRATION
...
## Limitations
- Superpowers path is parallel to canonical /evolve — not Engine-executed
